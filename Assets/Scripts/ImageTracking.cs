...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class ImageTracking : MonoBehaviour, ISerializationCallbackReceiver
    {
        /// <summary>
        ...
        /// </summary>
        [CustomEditor(typeof(ImageTracking))]
        class PrefabImagePairManagerInspector : Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                var behaviour = serializedObject.targetObject as ImageTracking;
